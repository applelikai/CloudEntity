...
namespace CloudEntity.Data.Entity
{
    ...
    public static class ExtendFunction
    {
        ...
        private static TProperty Function<TEntity, TProperty>(this IDbQuery<TEntity> source, string methodName, Expression<Func<TEntity, TProperty>> selector, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
            where TProperty : struct
        {
            //非空检查
        ...
        private static bool All<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
        {
        ...
        private static bool Any<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
        {
        ...
        public static int Avg<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, int>> selector)
            where TEntity : class
        {
        ...
        public static int Avg<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, int>> selector, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
        {
        ...
        /// <param name="selector">指定实体某属性表达式</param>
        /// <returns>实体数据源中所有实体某属性的平均值</returns>
        public static double Avg<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, double>> selector)
            where TEntity : class
        {
            return source.Function("Avg", selector);
        }
        ...
        /// <param name="predicate">筛选条件表达式</param>
        /// <returns>实体数据源中符合条件的实体某属性的平均值</returns>
        public static decimal Avg<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, decimal>> selector, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
        {
            return source.Function("Avg", selector, predicate);
        }
        ...
        public static int Sum<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, int>> selector)
            where TEntity : class
        {
        ...
        public static int Sum<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, int>> selector, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
        {
        ...
        /// <param name="predicate">筛选条件表达式</param>
        /// <returns>实体数据源中符合条件的元素某属性的和</returns>
        public static double Sum<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, double>> selector, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
        {
            return source.Function("Sum", selector, predicate);
        }
        ...
        /// <param name="selector">指定实体某属性表达式</param>
        /// <returns>实体数据源中所有元素某属性的和</returns>
        public static decimal Sum<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, decimal>> selector)
            where TEntity : class
        {
            return source.Function("Sum", selector);
        }
        ...
        public static int Count<TEntity>(this IDbQuery<TEntity> source)
            where TEntity : class
        {
            //检查数据源是否为空
            Check.ArgumentNull(source, nameof(source));
        ...
        public static int Count<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
        {
        ...
        /// <param name="predicate">指定与对象属性比较的表达式</param>
        /// <returns>元素个数</returns>
        public static long LongCount<TEntity>(this IDbQuery<TEntity> source, Expression<Func<TEntity, bool>> predicate)
            where TEntity : class
        {

...
{
    /// <summary>
    /// 用于Sql Server的为Table添加列的语句生成树
    /// Apple_Li 李凯 15150598493
    /// </summary>
    internal class SqlAlterTableAddColumnsTree : AlterTableAddColumnsTree
    {
        /// <summary>
        /// 拼接ALTER TABLE
        /// </summary>
        ...
        /// <param name="tableName">表名</param>
        /// <param name="schemaName">数据库架构名</param>
        public SqlAlterTableAddColumnsTree(ColumnNodeHelper columnNodeHelper, string tableName, string schemaName)

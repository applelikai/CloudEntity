...
{
    /// <summary>
    /// 用于Sql Server的建表语句生成树
    /// Apple_Li 李凯 15150598493
    /// </summary>
    internal class SqlBuildTableTree : BuildTableTree
    {
        /// <summary>
        /// 拼接CREATE TABLE语句
        /// </summary>
        ...
        /// <param name="tableName">表名</param>
        /// <param name="schemaName">数据库架构名</param>
        public SqlBuildTableTree(ColumnNodeHelper columnNodeHelper, string tableName, string schemaName = null)
